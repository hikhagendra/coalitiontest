<?php
    ...
    if ( ! function_exists( 'coalition_breadcrumb' ) ) {
        function coalition_breadcrumb ( $list_style = 'ol', $list_id = 'breadcrumb', $list_class = 'breadcrumb', $active_class = 'active', $echo = false ) {
